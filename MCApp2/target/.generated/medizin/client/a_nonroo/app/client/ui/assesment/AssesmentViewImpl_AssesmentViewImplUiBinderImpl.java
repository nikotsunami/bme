...
public class AssesmentViewImpl_AssesmentViewImplUiBinderImpl implements UiBinder<com.google.gwt.user.client.ui.Widget, medizin.client.a_nonroo.app.client.ui.assesment.AssesmentViewImpl>, medizin.client.a_nonroo.app.client.ui.assesment.AssesmentViewImpl.AssesmentViewImplUiBinder {

  public com.google.gwt.user.client.ui.Widget createAndBindUi(final medizin.client.a_nonroo.app.client.ui.assesment.AssesmentViewImpl owner) {

    medizin.client.a_nonroo.app.client.ui.assesment.AssesmentViewImpl_AssesmentViewImplUiBinderImpl_GenBundle clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay = (medizin.client.a_nonroo.app.client.ui.assesment.AssesmentViewImpl_AssesmentViewImplUiBinderImpl_GenBundle) GWT.create(medizin.client.a_nonroo.app.client.ui.assesment.AssesmentViewImpl_AssesmentViewImplUiBinderImpl_GenBundle.class);
    medizin.client.a_nonroo.app.client.ui.assesment.AssesmentViewImpl_AssesmentViewImplUiBinderImpl_GenCss_style style = clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay.style();
    ...
    table.setWidth("100%");
    table.setPageSize(8);
    newButton.setHTML("<span class='ui-icon ui-icon-plusthick' style='float: left; margin-right: 0.3em;'></span>neuer Prüfung erstellen");
