...
public abstract class QuestionAccessEditActivityWrapper_Roo_Gwt implements Activity, IsScaffoldMobileActivity {
    ...
    public interface View_Roo_Gwt<V extends medizin.client.scaffold.place.ProxyEditView<medizin.client.managed.request.QuestionAccessProxy, V>> extends ProxyEditView<QuestionAccessProxy, V> {
