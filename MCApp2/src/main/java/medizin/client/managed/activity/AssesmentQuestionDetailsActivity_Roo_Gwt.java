...
public abstract class AssesmentQuestionDetailsActivity_Roo_Gwt extends AbstractActivity implements Delegate, IsScaffoldMobileActivity {

    protected ApplicationRequestFactory requests;

    protected EntityProxyId<AssesmentQuestionProxy> proxyId;

    protected void find(Receiver<EntityProxy> callback) {
        requests.find(proxyId).with("rewiewer", "autor", "question", "assesment", "answersToAssQuestion").fire(callback);
    }
}
