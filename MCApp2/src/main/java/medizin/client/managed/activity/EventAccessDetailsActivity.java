...
public class EventAccessDetailsActivity extends EventAccessDetailsActivity_Roo_Gwt {

    private final PlaceController placeController;

    private final ProxyDetailsView<EventAccessProxy> view;

    private AcceptsOneWidget display;

    public EventAccessDetailsActivity(EntityProxyId<medizin.client.managed.request.EventAccessProxy> proxyId, ApplicationRequestFactory requests, PlaceController placeController, ProxyDetailsView<medizin.client.managed.request.EventAccessProxy> view) {
    ...
    public void deleteClicked() {
        ...
        requests.eventAccessRequest().remove().using(view.getValue()).fire(new Receiver<Void>() {
    ...
    public Place getBackButtonPlace() {
        return new ProxyListPlace(EventAccessProxy.class);
    }
    ...
    public void start(AcceptsOneWidget displayIn, EventBus eventBus) {
        ...
        Receiver<EntityProxy> callback = new Receiver<EntityProxy>() {
            ...
            public void onSuccess(EntityProxy proxy) {
                ...
                view.setValue((EventAccessProxy) proxy);
