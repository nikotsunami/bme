...
public class StaticToAssesmentDetailsActivity extends StaticToAssesmentDetailsActivity_Roo_Gwt {

    private final PlaceController placeController;

    private final ProxyDetailsView<StaticToAssesmentProxy> view;

    private AcceptsOneWidget display;

    public StaticToAssesmentDetailsActivity(EntityProxyId<medizin.client.managed.request.StaticToAssesmentProxy> proxyId, ApplicationRequestFactory requests, PlaceController placeController, ProxyDetailsView<medizin.client.managed.request.StaticToAssesmentProxy> view) {
    ...
    public void deleteClicked() {
        ...
        requests.staticToAssesmentRequest().remove().using(view.getValue()).fire(new Receiver<Void>() {
    ...
    public Place getBackButtonPlace() {
        return new ProxyListPlace(StaticToAssesmentProxy.class);
    }
    ...
    public void start(AcceptsOneWidget displayIn, EventBus eventBus) {
        ...
        Receiver<EntityProxy> callback = new Receiver<EntityProxy>() {
            ...
            public void onSuccess(EntityProxy proxy) {
                ...
                view.setValue((StaticToAssesmentProxy) proxy);
