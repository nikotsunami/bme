...
public class PersonListActivity extends AbstractProxyListActivity<PersonProxy> implements IsScaffoldMobileActivity {

    private final ApplicationRequestFactory requests;

    public PersonListActivity(ApplicationRequestFactory requests, ProxyListView<medizin.client.managed.request.PersonProxy> view, PlaceController placeController) {
    ...
    protected Request<java.util.List<medizin.client.managed.request.PersonProxy>> createRangeRequest(Range range) {
