...
public class McDetailsActivity extends McDetailsActivity_Roo_Gwt {

    private final PlaceController placeController;

    private final ProxyDetailsView<McProxy> view;

    private AcceptsOneWidget display;

    public McDetailsActivity(EntityProxyId<medizin.client.managed.request.McProxy> proxyId, ApplicationRequestFactory requests, PlaceController placeController, ProxyDetailsView<medizin.client.managed.request.McProxy> view) {
    ...
    public void deleteClicked() {
        ...
        requests.mcRequest().remove().using(view.getValue()).fire(new Receiver<Void>() {
    ...
    public Place getBackButtonPlace() {
        return new ProxyListPlace(McProxy.class);
    }
