...
public class KeywordEditActivityWrapper extends KeywordEditActivityWrapper_Roo_Gwt {
    ...
    public KeywordEditActivityWrapper(ApplicationRequestFactory requests, View<?> view, Activity activity, EntityProxyId<medizin.client.managed.request.KeywordProxy> proxyId) {
    ...
    public interface View<V extends medizin.client.scaffold.place.ProxyEditView<medizin.client.managed.request.KeywordProxy, V>> extends View_Roo_Gwt<V> {
    }
}
