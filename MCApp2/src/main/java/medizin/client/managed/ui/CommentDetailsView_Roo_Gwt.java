...
public abstract class CommentDetailsView_Roo_Gwt extends Composite implements ProxyDetailsView<CommentProxy> {
    ...
    public void setValue(CommentProxy proxy) {
        ...
        displayRenderer.setInnerText(medizin.client.managed.ui.CommentProxyRenderer.instance().render(proxy));
    }
}
