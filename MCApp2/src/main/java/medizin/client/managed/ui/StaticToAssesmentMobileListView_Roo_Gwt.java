...
public abstract class StaticToAssesmentMobileListView_Roo_Gwt extends MobileProxyListView<StaticToAssesmentProxy> {

    protected Set<String> paths = new HashSet<String>();

    public StaticToAssesmentMobileListView_Roo_Gwt(String buttonText, SafeHtmlRenderer<medizin.client.managed.request.StaticToAssesmentProxy> renderer) {
