...
public abstract class McMobileListView_Roo_Gwt extends MobileProxyListView<McProxy> {

    protected Set<String> paths = new HashSet<String>();

    public McMobileListView_Roo_Gwt(String buttonText, SafeHtmlRenderer<medizin.client.managed.request.McProxy> renderer) {
