...
import medizin.client.managed.ui.KeywordMobileDetailsView.Binder;
...
public class KeywordMobileDetailsView extends KeywordMobileDetailsView_Roo_Gwt {
    ...
    private static medizin.client.managed.ui.KeywordMobileDetailsView instance;
    ...
    public static medizin.client.managed.ui.KeywordMobileDetailsView instance() {
        if (instance == null) {
