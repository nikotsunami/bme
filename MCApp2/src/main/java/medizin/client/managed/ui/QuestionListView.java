...
import medizin.client.managed.ui.QuestionListView.Binder;
import medizin.client.scaffold.place.AbstractProxyListView;

public class QuestionListView extends QuestionListView_Roo_Gwt {

    private static final Binder BINDER = GWT.create(Binder.class);

    private static medizin.client.managed.ui.QuestionListView instance;
    ...
    public static medizin.client.managed.ui.QuestionListView instance() {
        if (instance == null) {
            instance = new QuestionListView();
        }
        return instance;
    }
    ...
    interface Binder extends UiBinder<HTMLPanel, QuestionListView> {
    }
}
