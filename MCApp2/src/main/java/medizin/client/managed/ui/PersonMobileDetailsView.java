...
import medizin.client.managed.ui.PersonMobileDetailsView.Binder;
...
public class PersonMobileDetailsView extends PersonMobileDetailsView_Roo_Gwt {
    ...
    private static medizin.client.managed.ui.PersonMobileDetailsView instance;
    ...
    public static medizin.client.managed.ui.PersonMobileDetailsView instance() {
        if (instance == null) {
