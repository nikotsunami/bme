...
public class AssesmentQuestionViewImpl_QuestionViewImplUiBinderImpl implements UiBinder<com.google.gwt.user.client.ui.Widget, medizin.client.a_nonroo.app.client.ui.assignquestion.AssesmentQuestionViewImpl>, medizin.client.a_nonroo.app.client.ui.assignquestion.AssesmentQuestionViewImpl.QuestionViewImplUiBinder {

  public com.google.gwt.user.client.ui.Widget createAndBindUi(final medizin.client.a_nonroo.app.client.ui.assignquestion.AssesmentQuestionViewImpl owner) {

    medizin.client.a_nonroo.app.client.ui.assignquestion.AssesmentQuestionViewImpl_QuestionViewImplUiBinderImpl_GenBundle clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay = (medizin.client.a_nonroo.app.client.ui.assignquestion.AssesmentQuestionViewImpl_QuestionViewImplUiBinderImpl_GenBundle) GWT.create(medizin.client.a_nonroo.app.client.ui.assignquestion.AssesmentQuestionViewImpl_QuestionViewImplUiBinderImpl_GenBundle.class);
    medizin.client.a_nonroo.app.client.ui.assignquestion.AssesmentQuestionViewImpl_QuestionViewImplUiBinderImpl_GenCss_style style = clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay.style();
    ...
    com.google.gwt.user.client.ui.Label deleteFromAssesment = (com.google.gwt.user.client.ui.Label) GWT.create(com.google.gwt.user.client.ui.Label.class);
    ...
    com.google.gwt.user.client.ui.HTMLPanel detailsTablePanel = new com.google.gwt.user.client.ui.HTMLPanel("<table class='" + "" + style.questionDetails() + "" + "'> <tr id='questEvent'> <td style='width: 100px;'> <span class='" + "" + style.label() + "" + "'>Themenbereich:</span> </td> <td style='width: 50%;'> <span id='" + domId7 + "'></span> </td> <td style='width: 100px;'> <span class='" + "" + style.label() + "" + "'>Fragentyp:</span> </td> <td style='width: 50%;'> <span id='" + domId8 + "'></span> </td> <tr id='rewiewer'> <td> <span class='" + "" + style.label() + "" + "'>Reviewer:</span> </td> <td> <span id='" + domId9 + "'></span> </td> <td> <span class='" + "" + style.label() + "" + "'>Autor:</span> </td> <td> <span id='" + domId10 + "'></span> </td> </tr> </tr> <tr id='keywords'> <td> <span class='" + "" + style.label() + "" + "'>Keywords:</span> </td> <td collspan='3'> <span id='" + domId11 + "'></span> </td> </tr> <tr id='comment'> <td> <span class='" + "" + style.label() + "" + "'>Kommentar:</span> </td> <td collspan='3'> <span id='" + domId12 + "'></span> </td> </tr> </table>");
    com.google.gwt.user.client.ui.HTMLPanel f_HTMLPanel1 = new com.google.gwt.user.client.ui.HTMLPanel("<table cellpadding='0' cellspacing='0' class='" + "" + style.questionTable() + "" + "'> <tr> <td class='" + "" + style.headerIcon() + "" + "' valign='top' width='20px'> <span id='" + domId0 + "'></span> <span id='" + domId1 + "'></span> </td> <td class='" + "" + style.header() + "" + "' valign='top' width='100%'> <span id='" + domId2 + "'></span> </td> <td class='" + "" + style.headerIcon() + "" + "' valign='top'> <span id='" + domId3 + "'></span> <span id='" + domId4 + "'></span> </td> </tr> </table> <span id='" + domId5 + "'></span> <span id='" + domId6 + "'></span>");
    ...
    deleteFromAssesment.setStyleName("ui-icon ui-icon-closethick " + style.fill() + "");
    ...
    questEvent = com.google.gwt.dom.client.Document.get().getElementById(domId7).cast();
    questEvent.removeAttribute("id");
    questionType = com.google.gwt.dom.client.Document.get().getElementById(domId8).cast();
    questionType.removeAttribute("id");
    rewiewer = com.google.gwt.dom.client.Document.get().getElementById(domId9).cast();
    rewiewer.removeAttribute("id");
    autor = com.google.gwt.dom.client.Document.get().getElementById(domId10).cast();
    autor.removeAttribute("id");
    keywords = com.google.gwt.dom.client.Document.get().getElementById(domId11).cast();
    keywords.removeAttribute("id");
    comment = com.google.gwt.dom.client.Document.get().getElementById(domId12).cast();
    ...
    f_HTMLPanel1.addAndReplaceElement(deleteFromAssesment, domId3Element);
    f_HTMLPanel1.addAndReplaceElement(addToAssesment, domId4Element);
    f_HTMLPanel1.addAndReplaceElement(answers, domId5Element);
    f_HTMLPanel1.addAndReplaceElement(detailsTablePanel, domId6Element);
    ...
    owner.deleteFromAssesment = deleteFromAssesment;
