...
public class SimplePager_Resources_default_StaticClientBundleGenerator implements com.google.gwt.user.cellview.client.SimplePager.Resources {
  ...
  private void _init0() {
    ...
    public String getText() {
      return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".GF2JA2OBH{padding:" + ("4px"+ " " +"8px")  + ";text-align:" + ("center")  + ";}.GF2JA2OPG{padding:" + ("4px")  + ";cursor:" + ("pointer")  + ";cursor:" + ("hand")  + ";}.GF2JA2OAH{cursor:" + ("default")  + ";}")) : ((".GF2JA2OBH{padding:" + ("4px"+ " " +"8px")  + ";text-align:" + ("center")  + ";}.GF2JA2OPG{padding:" + ("4px")  + ";cursor:" + ("pointer")  + ";cursor:" + ("hand")  + ";}.GF2JA2OAH{cursor:" + ("default")  + ";}"));
    }
  ...
  static {
    new SimplePager_Resources_default_StaticClientBundleGenerator()._init0();
  }
