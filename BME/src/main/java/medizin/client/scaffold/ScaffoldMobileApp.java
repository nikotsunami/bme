...
import medizin.client.managed.activity.*;
...
import medizin.client.scaffold.place.*;
import medizin.client.style.MobileListResources;
import medizin.shared.scaffold.*;
