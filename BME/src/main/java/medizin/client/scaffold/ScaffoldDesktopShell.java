package medizin.client.scaffold;

import medizin.client.managed.ui.ApplicationListPlaceRenderer;
import medizin.client.scaffold.place.ProxyListPlace;
import medizin.client.scaffold.ui.LoginWidget;
...
public class ScaffoldDesktopShell extends Composite {
	...
	/**
	 * @return the panel tha contains the main Navigation //Dave added
	 */
	public SimplePanel getMainNavPanel() {
		return mainNavPanel;
	}	
