...
public abstract class QuestionTypeEditActivityWrapper_Roo_Gwt implements Activity, IsScaffoldMobileActivity {
    ...
    public interface View_Roo_Gwt<V extends medizin.client.scaffold.place.ProxyEditView<medizin.client.managed.request.QuestionTypeProxy, V>> extends ProxyEditView<QuestionTypeProxy, V> {
    }
}
