...
public class StaticContentDetailsActivity extends StaticContentDetailsActivity_Roo_Gwt {

    private final PlaceController placeController;

    private final ProxyDetailsView<StaticContentProxy> view;

    private AcceptsOneWidget display;

    public StaticContentDetailsActivity(EntityProxyId<medizin.client.managed.request.StaticContentProxy> proxyId, ApplicationRequestFactory requests, PlaceController placeController, ProxyDetailsView<medizin.client.managed.request.StaticContentProxy> view) {
    ...
    public void deleteClicked() {
        ...
        requests.staticContentRequest().remove().using(view.getValue()).fire(new Receiver<Void>() {
    ...
    public Place getBackButtonPlace() {
        return new ProxyListPlace(StaticContentProxy.class);
    }
    ...
    public void start(AcceptsOneWidget displayIn, EventBus eventBus) {
        ...
        Receiver<EntityProxy> callback = new Receiver<EntityProxy>() {
            ...
            public void onSuccess(EntityProxy proxy) {
                ...
                view.setValue((StaticContentProxy) proxy);
