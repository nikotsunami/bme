...
public class CommentDetailsActivity extends CommentDetailsActivity_Roo_Gwt {

    private final PlaceController placeController;

    private final ProxyDetailsView<CommentProxy> view;

    private AcceptsOneWidget display;

    public CommentDetailsActivity(EntityProxyId<medizin.client.managed.request.CommentProxy> proxyId, ApplicationRequestFactory requests, PlaceController placeController, ProxyDetailsView<medizin.client.managed.request.CommentProxy> view) {
    ...
    public void deleteClicked() {
        ...
        requests.commentRequest().remove().using(view.getValue()).fire(new Receiver<Void>() {
    ...
    public Place getBackButtonPlace() {
        return new ProxyListPlace(CommentProxy.class);
    }
    ...
    public void start(AcceptsOneWidget displayIn, EventBus eventBus) {
        ...
        Receiver<EntityProxy> callback = new Receiver<EntityProxy>() {
            ...
            public void onSuccess(EntityProxy proxy) {
                ...
                view.setValue((CommentProxy) proxy);
