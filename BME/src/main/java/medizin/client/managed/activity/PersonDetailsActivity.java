...
public class PersonDetailsActivity extends PersonDetailsActivity_Roo_Gwt {
    ...
    public PersonDetailsActivity(EntityProxyId<medizin.client.managed.request.PersonProxy> proxyId, ApplicationRequestFactory requests, PlaceController placeController, ProxyDetailsView<medizin.client.managed.request.PersonProxy> view) {
