...
/**
 * Activity for handling AssesmentQuestionDetailsViews.
 * @author masterthesis
 *
 */
public class AssesmentQuestionDetailsActivity extends AssesmentQuestionDetailsActivity_Roo_Gwt {

    private final PlaceController placeController;

    private final ProxyDetailsView<AssesmentQuestionProxy> view;

    private AcceptsOneWidget display;

    public AssesmentQuestionDetailsActivity(EntityProxyId<medizin.client.managed.request.AssesmentQuestionProxy> proxyId, ApplicationRequestFactory requests, PlaceController placeController, ProxyDetailsView<medizin.client.managed.request.AssesmentQuestionProxy> view) {
    ...
    public void deleteClicked() {
        ...
        requests.assesmentQuestionRequest().remove().using(view.getValue()).fire(new Receiver<Void>() {
    ...
    public Place getBackButtonPlace() {
        return new ProxyListPlace(AssesmentQuestionProxy.class);
    }
    ...
    public void start(AcceptsOneWidget displayIn, EventBus eventBus) {
        ...
        Receiver<EntityProxy> callback = new Receiver<EntityProxy>() {
            ...
            public void onSuccess(EntityProxy proxy) {
                ...
                view.setValue((AssesmentQuestionProxy) proxy);
