...
public abstract class CommentEditActivityWrapper_Roo_Gwt implements Activity, IsScaffoldMobileActivity {
    ...
    public interface View_Roo_Gwt<V extends medizin.client.scaffold.place.ProxyEditView<medizin.client.managed.request.CommentProxy, V>> extends ProxyEditView<CommentProxy, V> {
    }
}
