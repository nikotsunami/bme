...
public class InstitutionDetailsActivity extends InstitutionDetailsActivity_Roo_Gwt {

    private final PlaceController placeController;

    private final ProxyDetailsView<InstitutionProxy> view;

    private AcceptsOneWidget display;

    public InstitutionDetailsActivity(EntityProxyId<medizin.client.managed.request.InstitutionProxy> proxyId, ApplicationRequestFactory requests, PlaceController placeController, ProxyDetailsView<medizin.client.managed.request.InstitutionProxy> view) {
    ...
    public void deleteClicked() {
        ...
        requests.institutionRequest().remove().using(view.getValue()).fire(new Receiver<Void>() {
    ...
    public Place getBackButtonPlace() {
        return new ProxyListPlace(InstitutionProxy.class);
    }
    ...
    public void start(AcceptsOneWidget displayIn, EventBus eventBus) {
        ...
        Receiver<EntityProxy> callback = new Receiver<EntityProxy>() {
            ...
            public void onSuccess(EntityProxy proxy) {
                ...
                view.setValue((InstitutionProxy) proxy);
