...
public class AaManageQuestionsActivitiesMapper_nonroo {

    private final ApplicationRequestFactory requests;

    private final PlaceController placeController;

    public AaManageQuestionsActivitiesMapper_nonroo(ApplicationRequestFactory requests, PlaceController placeController) {
        this.requests = requests;
        this.placeController = placeController;
    }

    public Activity getActivity(ManageQuestionsPlace_nonroo place) {
    ...
    private EntityProxyId<medizin.client.managed.request.AnswerProxy> coerceId(ManageQuestionsPlace_nonroo place) {
    ...
    private Activity makeEditActivity(ManageQuestionsPlace_nonroo place) {
