...
public class QuestionDetailsActivity extends QuestionDetailsActivity_Roo_Gwt {

    private final PlaceController placeController;

    private final ProxyDetailsView<QuestionProxy> view;

    private AcceptsOneWidget display;

    public QuestionDetailsActivity(EntityProxyId<medizin.client.managed.request.QuestionProxy> proxyId, ApplicationRequestFactory requests, PlaceController placeController, ProxyDetailsView<medizin.client.managed.request.QuestionProxy> view) {
    ...
    public void deleteClicked() {
        ...
        requests.questionRequest().remove().using(view.getValue()).fire(new Receiver<Void>() {
    ...
    public Place getBackButtonPlace() {
        return new ProxyListPlace(QuestionProxy.class);
    }
    ...
    public void start(AcceptsOneWidget displayIn, EventBus eventBus) {
        ...
        Receiver<EntityProxy> callback = new Receiver<EntityProxy>() {
            ...
            public void onSuccess(EntityProxy proxy) {
                ...
                view.setValue((QuestionProxy) proxy);
