...
public class AnswerDetailsActivity extends AnswerDetailsActivity_Roo_Gwt {

    private final PlaceController placeController;

    private final ProxyDetailsView<AnswerProxy> view;

    private AcceptsOneWidget display;

    public AnswerDetailsActivity(EntityProxyId<medizin.client.managed.request.AnswerProxy> proxyId, ApplicationRequestFactory requests, PlaceController placeController, ProxyDetailsView<medizin.client.managed.request.AnswerProxy> view) {
    ...
    public Place getBackButtonPlace() {
        return new ProxyListPlace(AnswerProxy.class);
    }
    ...
    public void start(AcceptsOneWidget displayIn, EventBus eventBus) {
        ...
        Receiver<EntityProxy> callback = new Receiver<EntityProxy>() {
            ...
            public void onSuccess(EntityProxy proxy) {
                ...
                view.setValue((AnswerProxy) proxy);
