...
public class QuestionTypeCountPerExamDetailsActivity extends QuestionTypeCountPerExamDetailsActivity_Roo_Gwt {

    private final PlaceController placeController;

    private final ProxyDetailsView<QuestionTypeCountPerExamProxy> view;

    private AcceptsOneWidget display;

    public QuestionTypeCountPerExamDetailsActivity(EntityProxyId<medizin.client.managed.request.QuestionTypeCountPerExamProxy> proxyId, ApplicationRequestFactory requests, PlaceController placeController, ProxyDetailsView<medizin.client.managed.request.QuestionTypeCountPerExamProxy> view) {
    ...
    public void deleteClicked() {
        ...
        requests.questionTypeCountPerExamRequest().remove().using(view.getValue()).fire(new Receiver<Void>() {
    ...
    public Place getBackButtonPlace() {
        return new ProxyListPlace(QuestionTypeCountPerExamProxy.class);
    }
    ...
    public String getTitleText() {
        return "View QuestionTypeCountPerExam";
    }
    ...
    public void start(AcceptsOneWidget displayIn, EventBus eventBus) {
        ...
        Receiver<EntityProxy> callback = new Receiver<EntityProxy>() {
            ...
            public void onSuccess(EntityProxy proxy) {
                ...
                view.setValue((QuestionTypeCountPerExamProxy) proxy);
