...
public class PersonEditActivityWrapper extends PersonEditActivityWrapper_Roo_Gwt {
    ...
    public PersonEditActivityWrapper(ApplicationRequestFactory requests, View<?> view, Activity activity, EntityProxyId<medizin.client.managed.request.PersonProxy> proxyId) {
    ...
    public interface View<V extends medizin.client.scaffold.place.ProxyEditView<medizin.client.managed.request.PersonProxy, V>> extends View_Roo_Gwt<V> {
    }
}
