...
public class AssesmentListActivity extends AbstractProxyListActivity<AssesmentProxy> implements IsScaffoldMobileActivity {

    private final ApplicationRequestFactory requests;

    public AssesmentListActivity(ApplicationRequestFactory requests, ProxyListView<medizin.client.managed.request.AssesmentProxy> view, PlaceController placeController) {
        super(placeController, view, AssesmentProxy.class);
