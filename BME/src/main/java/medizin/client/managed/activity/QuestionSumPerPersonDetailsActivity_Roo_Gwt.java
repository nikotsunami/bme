...
public abstract class QuestionSumPerPersonDetailsActivity_Roo_Gwt extends AbstractActivity implements Delegate, IsScaffoldMobileActivity {

    protected ApplicationRequestFactory requests;

    protected EntityProxyId<QuestionSumPerPersonProxy> proxyId;

    protected void find(Receiver<EntityProxy> callback) {
        requests.find(proxyId).with("responsiblePerson", "questionEvent", "assesment").fire(callback);
    }
}
