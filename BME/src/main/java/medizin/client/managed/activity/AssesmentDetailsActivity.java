...
/**
 * 
 * Activity for handling AssesmentDetailsViews.
 * @author masterthesis
 *
 */

public class AssesmentDetailsActivity extends AssesmentDetailsActivity_Roo_Gwt {

    private final PlaceController placeController;

    private final ProxyDetailsView<AssesmentProxy> view;

    private AcceptsOneWidget display;

    public AssesmentDetailsActivity(EntityProxyId<medizin.client.managed.request.AssesmentProxy> proxyId, ApplicationRequestFactory requests, PlaceController placeController, ProxyDetailsView<medizin.client.managed.request.AssesmentProxy> view) {
    ...
    public void deleteClicked() {
        ...
        requests.assesmentRequest().remove().using(view.getValue()).fire(new Receiver<Void>() {
    ...
    public Place getBackButtonPlace() {
        return new ProxyListPlace(AssesmentProxy.class);
    }
    ...
    public void start(AcceptsOneWidget displayIn, EventBus eventBus) {
        ...
        Receiver<EntityProxy> callback = new Receiver<EntityProxy>() {
            ...
            public void onSuccess(EntityProxy proxy) {
                ...
                view.setValue((AssesmentProxy) proxy);
