...
public class QuestionAccessDetailsActivity extends QuestionAccessDetailsActivity_Roo_Gwt {

    private final PlaceController placeController;

    private final ProxyDetailsView<QuestionAccessProxy> view;

    private AcceptsOneWidget display;

    public QuestionAccessDetailsActivity(EntityProxyId<medizin.client.managed.request.QuestionAccessProxy> proxyId, ApplicationRequestFactory requests, PlaceController placeController, ProxyDetailsView<medizin.client.managed.request.QuestionAccessProxy> view) {
    ...
    public void deleteClicked() {
        ...
        requests.questionAccessRequest().remove().using(view.getValue()).fire(new Receiver<Void>() {
    ...
    public Place getBackButtonPlace() {
        return new ProxyListPlace(QuestionAccessProxy.class);
    }
    ...
    public void start(AcceptsOneWidget displayIn, EventBus eventBus) {
        ...
        Receiver<EntityProxy> callback = new Receiver<EntityProxy>() {
            ...
            public void onSuccess(EntityProxy proxy) {
                ...
                view.setValue((QuestionAccessProxy) proxy);
