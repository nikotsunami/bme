...
public class QuestionTypeListActivity extends AbstractProxyListActivity<QuestionTypeProxy> implements IsScaffoldMobileActivity {

    private final ApplicationRequestFactory requests;

    public QuestionTypeListActivity(ApplicationRequestFactory requests, ProxyListView<medizin.client.managed.request.QuestionTypeProxy> view, PlaceController placeController) {
        super(placeController, view, QuestionTypeProxy.class);
