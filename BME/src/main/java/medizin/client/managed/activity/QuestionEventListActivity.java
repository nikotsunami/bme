...
public class QuestionEventListActivity extends AbstractProxyListActivity<QuestionEventProxy> implements IsScaffoldMobileActivity {

    private final ApplicationRequestFactory requests;

    public QuestionEventListActivity(ApplicationRequestFactory requests, ProxyListView<medizin.client.managed.request.QuestionEventProxy> view, PlaceController placeController) {
        super(placeController, view, QuestionEventProxy.class);
    ...
    protected Request<java.util.List<medizin.client.managed.request.QuestionEventProxy>> createRangeRequest(Range range) {
        return requests.questionEventRequest().findQuestionEventEntries(range.getStart(), range.getLength());
    }

    protected void fireCountRequest(Receiver<Long> callback) {
       // requests.questionEventRequest().countQuestionEvents().fire(callback);
    }
}
