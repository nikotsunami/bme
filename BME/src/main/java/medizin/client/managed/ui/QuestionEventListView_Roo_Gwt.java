...
public abstract class QuestionEventListView_Roo_Gwt extends AbstractProxyListView<QuestionEventProxy> {

    @UiField
    CellTable<QuestionEventProxy> table;

    protected Set<String> paths = new HashSet<String>();

    public void init() {
        paths.add("eventName");
        table.addColumn(new TextColumn<QuestionEventProxy>() {
