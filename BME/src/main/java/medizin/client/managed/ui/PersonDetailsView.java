...
import medizin.client.managed.ui.PersonDetailsView.Binder;
...
public class PersonDetailsView extends PersonDetailsView_Roo_Gwt {
    ...
    private static medizin.client.managed.ui.PersonDetailsView instance;
    ...
    public static medizin.client.managed.ui.PersonDetailsView instance() {
        if (instance == null) {
