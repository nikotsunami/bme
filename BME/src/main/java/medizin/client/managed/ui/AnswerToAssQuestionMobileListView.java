...
public class AnswerToAssQuestionMobileListView extends AnswerToAssQuestionMobileListView_Roo_Gwt {

    private static medizin.client.managed.ui.AnswerToAssQuestionMobileListView instance;

    public AnswerToAssQuestionMobileListView() {
        super("New AnswerToAssQuestion", new CellRenderer());
        init();
    }

    public static medizin.client.managed.ui.AnswerToAssQuestionMobileListView instance() {
        if (instance == null) {
            instance = new AnswerToAssQuestionMobileListView();
        }
        return instance;
    }
    ...
    private static class CellRenderer extends AbstractSafeHtmlRenderer<AnswerToAssQuestionProxy> {
        ...
        @Override
        public SafeHtml render(AnswerToAssQuestionProxy value) {
            if (value == null) {
