...
public class StaticToAssesmentMobileListView extends StaticToAssesmentMobileListView_Roo_Gwt {

    private static medizin.client.managed.ui.StaticToAssesmentMobileListView instance;

    public StaticToAssesmentMobileListView() {
        super("New StaticToAssesment", new CellRenderer());
        init();
    }

    public static medizin.client.managed.ui.StaticToAssesmentMobileListView instance() {
        if (instance == null) {
            instance = new StaticToAssesmentMobileListView();
        }
        return instance;
    }
    ...
    private static class CellRenderer extends AbstractSafeHtmlRenderer<StaticToAssesmentProxy> {
        ...
        @Override
        public SafeHtml render(StaticToAssesmentProxy value) {
            if (value == null) {
