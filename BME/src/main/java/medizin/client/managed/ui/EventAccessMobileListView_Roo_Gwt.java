...
public abstract class EventAccessMobileListView_Roo_Gwt extends MobileProxyListView<EventAccessProxy> {

    protected Set<String> paths = new HashSet<String>();

    public EventAccessMobileListView_Roo_Gwt(String buttonText, SafeHtmlRenderer<medizin.client.managed.request.EventAccessProxy> renderer) {
