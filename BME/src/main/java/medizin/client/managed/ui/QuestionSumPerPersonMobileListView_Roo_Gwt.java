...
public abstract class QuestionSumPerPersonMobileListView_Roo_Gwt extends MobileProxyListView<QuestionSumPerPersonProxy> {

    protected Set<String> paths = new HashSet<String>();

    public QuestionSumPerPersonMobileListView_Roo_Gwt(String buttonText, SafeHtmlRenderer<medizin.client.managed.request.QuestionSumPerPersonProxy> renderer) {
