...
public abstract class AnswerToAssQuestionMobileListView_Roo_Gwt extends MobileProxyListView<AnswerToAssQuestionProxy> {

    protected Set<String> paths = new HashSet<String>();

    public AnswerToAssQuestionMobileListView_Roo_Gwt(String buttonText, SafeHtmlRenderer<medizin.client.managed.request.AnswerToAssQuestionProxy> renderer) {
