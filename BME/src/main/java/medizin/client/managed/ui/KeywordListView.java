...
import medizin.client.managed.ui.KeywordListView.Binder;
...
public class KeywordListView extends KeywordListView_Roo_Gwt {
    ...
    private static medizin.client.managed.ui.KeywordListView instance;
    ...
    public static medizin.client.managed.ui.KeywordListView instance() {
        if (instance == null) {
