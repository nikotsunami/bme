...
import medizin.client.managed.ui.PersonMobileEditView.Binder;
...
public class PersonMobileEditView extends PersonMobileEditView_Roo_Gwt {
    ...
    private static medizin.client.managed.ui.PersonMobileEditView instance;
    ...
    public static medizin.client.managed.ui.PersonMobileEditView instance() {
        if (instance == null) {
    ...
    @Override
    public RequestFactoryEditorDriver<medizin.client.managed.request.PersonProxy, medizin.client.managed.ui.PersonMobileEditView> createEditorDriver() {
...
//	@Override
//	public void setLoggedPersonPickerValues(Collection<PersonProxy> values) {
