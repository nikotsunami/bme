...
public abstract class AssesmentMobileListView_Roo_Gwt extends MobileProxyListView<AssesmentProxy> {

    protected Set<String> paths = new HashSet<String>();

    public AssesmentMobileListView_Roo_Gwt(String buttonText, SafeHtmlRenderer<medizin.client.managed.request.AssesmentProxy> renderer) {
