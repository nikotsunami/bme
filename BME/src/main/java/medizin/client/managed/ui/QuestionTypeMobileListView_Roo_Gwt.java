...
public abstract class QuestionTypeMobileListView_Roo_Gwt extends MobileProxyListView<QuestionTypeProxy> {

    protected Set<String> paths = new HashSet<String>();

    public QuestionTypeMobileListView_Roo_Gwt(String buttonText, SafeHtmlRenderer<medizin.client.managed.request.QuestionTypeProxy> renderer) {
