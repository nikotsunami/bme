...
public abstract class QuestionTypeCountPerExamMobileListView_Roo_Gwt extends MobileProxyListView<QuestionTypeCountPerExamProxy> {

    protected Set<String> paths = new HashSet<String>();

    public QuestionTypeCountPerExamMobileListView_Roo_Gwt(String buttonText, SafeHtmlRenderer<medizin.client.managed.request.QuestionTypeCountPerExamProxy> renderer) {
