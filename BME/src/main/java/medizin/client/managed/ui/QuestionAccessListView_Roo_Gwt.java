...
public abstract class QuestionAccessListView_Roo_Gwt extends AbstractProxyListView<QuestionAccessProxy> {

    @UiField
    CellTable<QuestionAccessProxy> table;

    protected Set<String> paths = new HashSet<String>();

    public void init() {
        paths.add("accRights");
        table.addColumn(new TextColumn<QuestionAccessProxy>() {
