...
public abstract class AnswerMobileDetailsView_Roo_Gwt extends Composite implements ProxyDetailsView<AnswerProxy> {
    ...
    @UiField
    Element isAnswerActive;

    @UiField
    Element isPicture;

    @UiField
    Element isAnswerAcceptedReviewWahrer;

    @UiField
    Element isAnswerAcceptedAutor;

    @UiField
    Element isAnswerAcceptedAdmin;
